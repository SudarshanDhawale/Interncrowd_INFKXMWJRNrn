...
public class ResumeUI extends JFrame {
	...
	public ResumeUI() {
		...
		lblResume.setFont(new Font("CALIBRI", Font.BOLD, 25)); 
		
		JLabel lblPersonalInformation = new JLabel("Personal Information");
		lblPersonalInformation.setFont(new Font("CALIBRI", Font.BOLD, 25)); 
		...
		btnBrowse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent args) {
				...
				if(fb.getS()!=null) {
					...
					lblNewLabel.setIcon(new ImageIcon("/home/Downloads/placeholder-200x200.png"));
				}
			}
		});
